      ...
      <div className="w-full max-w-sm animate-scale-in">
        ...
        <div className="flex flex-col items-center gap-2 pb-2">
          <a
            ...
            className="inline-flex items-center gap-1.5 text-sm font-medium text-[#25D366] hover:text-[#1aab53] transition-colors"
          >
            ...
            הצטרפו לקבוצת עידכונים שקטה
          </a>
          <a
            href="https://wa.me/972509230882"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1 text-xs text-caramel-400 hover:text-chocolate transition-colors"
          >
