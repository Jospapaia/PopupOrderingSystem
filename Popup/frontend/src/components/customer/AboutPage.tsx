    ...
    <div className="min-h-screen bg-parchment" dir="rtl">
      ...
      {about?.image_url ? (
        <div className="relative w-full bg-parchment">
          ...
          <a
            href="/"
            className="fixed top-4 right-4 z-50 flex items-center justify-center w-9 h-9 rounded-full bg-black/40 backdrop-blur-sm text-white/90 hover:bg-black/60 hover:text-white transition-colors text-2xl leading-none shadow-md"
          >
            ‹
          </a>
        </div>
      ...
      <main className="max-w-sm mx-auto px-5 py-7">
        ...
        {about?.bio_text && (
          <div className="bg-white rounded-2xl px-5 py-5 shadow-card text-base text-caramel-700 leading-loose whitespace-pre-line text-justify">
            {about.bio_text}
          </div>
        )}
        ...
        <div className="mt-8 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-caramel-500 hover:text-chocolate transition-colors"
          >
